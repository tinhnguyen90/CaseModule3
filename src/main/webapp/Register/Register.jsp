            ...
            <div class="signup-content">
                <form action="/register" method="post" id="signup-form" class="signup-form">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-input" name="username" id="name" placeholder="User Name"/>
                    </div>
                    <div class="form-group">
                ...
                <p class="loginhere">
                    Have already an account ? <a href="http://localhost:8080/login" class="loginhere-link">Login here</a>
                </p>
            </div>
        </div>
    </section>
